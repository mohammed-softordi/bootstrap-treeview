    ...
    g.prototype.init = function (b) {
        ...
        if (b) {
            ...
            a.each(b, function (b, e) {
                ...
                var h = [];
                if (e.nodes ? (h.push("expand-icon"), e.state.expanded ? h.push(d.options.collapseIcon) : h.push(d.options.expandIcon)) : h.push(d.options.emptyIcon), f.append(a(d.template.icon).addClass(h.join(" "))), d.options.showIcon) {
                    var h = ["node-icon"];
                ...
                return d.options.enableLinks && e.selectable ? f.append(a(d.template.link).attr("href", e.href).append(e.text)) : f.append(e.text), d.options.showTags && e.tags && a.each(e.tags, function (b, c) {
        ...
        return this.options.highlightSearchResults && a.searchResult && !a.state.disabled && (this.options.searchResultColor && (b = this.options.searchResultColor), this.options.searchResultBackColor && (c = this.options.searchResultBackColor)), this.options.highlightSelected && a.state.expanded && (this.options.expandedColor && (b = this.options.expandedColor), this.options.expandedBackColor && (c = this.options.expandedBackColor)), "color:" + b + ";background-color:" + c + ";"
